...
import {GetHospitalResponseData, HospitalRowData, SiteRowData, SuperadminSiteData} from "../../types/superadmin";
...
export const SuperadminSiteDataColumn = () => {
  const columnItem = [
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Name')}>
          Name
          <TbArrowsMoveVertical size={15}/>
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Email')}>
          Email
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Phone')}>
          Phone
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Country')}>
          Country
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('State')}>
          State
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('City')}>
          City
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Address')}>
        Address
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Status')}>
          Status
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
    ...
    {
      Header: <Fragment>
        <span className="flex shrink-0 flex-row gap-1" onClick={() => console.log('Created On')}>
          Registered On
          <TbArrowsMoveVertical size={15} />
        </span>
      </Fragment>,
