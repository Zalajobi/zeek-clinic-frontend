...
interface ModalButtonLunchProps {
  type:
    | 'primary'
    | 'secondary'
    | 'success'
...
export const ModalButtonOutlineLunch = ({
  type = 'primary',
  text,
  targetModalId,
  className = '',
...
export const ModalButtonLightLunch = ({
  type = 'primary',
  text,
  targetModalId,
  className = '',
...
export const ModalButtonFilledLunch = ({
  type = 'primary',
  text,
  targetModalId,
  className = '',
