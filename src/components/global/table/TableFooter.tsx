      ...
      <footer className="flex w-full flex-col items-center justify-between p-6 text-custom-primary-800 dark:text-white lg:flex-row px-7 py-5">
        ...
        <div className="mt-3 flex flex-col items-center gap-6 divide-ds-gray-300 dark:divide-ds-dark-400 lg:mt-0 lg:flex-row lg:divide-x">
          ...
          <span className="flex w-max flex-row items-center gap-1 lg:pl-6">
            <button
              className="grid h-8 w-8 place-items-center rounded-md border border-ds-gray-300 font-extrabold text-custom-primary-800 dark:border-ds-dark-400 dark:text-white" onClick={() => onPrevious(currentPage - 1)}>
              <IoMdArrowDropleft size={20}/>
            </button>

            <button className="grid h-8 w-8 place-items-center rounded-md border border-ds-gray-300 font-extrabold text-custom-primary-800 dark:border-ds-dark-400 dark:text-white" onClick={() => onNext(currentPage + 1)}>
