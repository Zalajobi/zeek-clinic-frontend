...
export const TypographySkeleton = ({ className = '' }: SkeletonProps) => {
  return (
    <p
      className={`ml-3 animate-pulse w-full h-4 bg-gray-200 rounded-md dark:bg-gray-700 ${className}`}></p>
  );
};
...
export const ImageSkeleton = ({ className = '' }: SkeletonProps) => {
  return (
    <div
      className={`flex items-center justify-center h-full w-full bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700 ${className}`}>
      <svg
