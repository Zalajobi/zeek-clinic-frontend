...
const Header = ({ name, query, role, handleSearch }: HeaderProps) => {
  return (
    <Fragment>
      <nav className="z-50 h-18 w-full border-b border-b-custom-gray-100 bg-white px-3 py-[0.375rem] dark:border-b-ds-dark-400 dark:!bg-ds-dark-700 md:px-7 lg:px-14">
